...
public class CompanyConfigDTO {
     ...
     * 开启客资属性设置
     */
    private boolean openClientAttr;

    /**
     * 全局搜索依据个人搜索权限
     */
    private boolean wholeSearchBySelf;



    public boolean isWholeSearchBySelf() {
        return wholeSearchBySelf;
    }

    public void setWholeSearchBySelf(boolean wholeSearchBySelf) {
        this.wholeSearchBySelf = wholeSearchBySelf;
    }

    public boolean isOpenClientAttr() {
        return openClientAttr;
    }

    public void setOpenClientAttr(boolean openClientAttr) {
        this.openClientAttr = openClientAttr;
    }
